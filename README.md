...
This repository contains a comprehensive cheat sheet for using Cursor, the AI-powered IDE.

## Table of Contents

1. [Installation and Uninstallation](installation/index.md)
   - [Install and Update](installation/install-update.md)
   - [Uninstall](installation/uninstall.md)

2. [Models](models/index.md)
   - [Model Ranking](models/ranking.md)
